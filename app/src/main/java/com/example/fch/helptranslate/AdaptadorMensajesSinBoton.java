...
public class AdaptadorMensajesSinBoton extends BaseAdapter   {
    //Variables
    private Context context;
    private ArrayList<Mensajes> listItems;

    // Getters, setter y constructor
    public AdaptadorMensajesSinBoton(Context context, ArrayList<Mensajes> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView=LayoutInflater.from(context).inflate(R.layout.item_mensajes_sinboton,null);
